...
# from models.msoc import MSOC
from models.msoc_sync import MSOC_Sync
...
if __name__ == "__main__":
    ...
    for random_seed in [42]:
        ...
        if args.wandb:
            ...
            wandb.init(
                project="MSOC_G_test_new",
                name=f"{args.name}_{random_seed}",
                reinit=True,
                config={
        ...
        args.save_name_id = args.name + "_seed:" + str(random_seed)
        ...
        if args.model_type == "MSOC":
            model = MSOC(
                ...
                video_threshold=args.visual_threshold,
