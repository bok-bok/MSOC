...
class SmallResNetLayer(nn.Module):
    # An efficient block with depthwise separable convolutions
    def __init__(self, in_channels, out_channels, stride=1):
        super(SmallResNetLayer, self).__init__()
...
class ResNet(nn.Module):
    ...
    def __init__(self, light=False):
        ...
        if light:
            self.layer1 = SmallResNetLayer(64, 64, stride=1)
            self.layer2 = SmallResNetLayer(64, 128, stride=2)
            self.layer3 = SmallResNetLayer(128, 256, stride=2)
            self.layer4 = SmallResNetLayer(256, 512, stride=2)
        else:
...
class visualFrontend(nn.Module):
    ...
    def __init__(self, light=False):
        ...
        self.resnet = ResNet(light=light)
        return
