...
# from .vivit_utils import print_on_rank_zero
    ...
    if isinstance(pretrained, str):
        ...
        for old_key in old_state_dict_keys:
            ...
            if "encoder.patch_embed.proj" in old_key:
                new_key = old_key.replace("encoder.patch_embed.proj", "patch_embed.projection")
            ...
            if "norm" in new_key:
                ...
                if "q_bias" in new_key:
                    ...
                    weight = torch.cat((q_bias, torch.zeros_like(q_bias, requires_grad=False), v_bias))
