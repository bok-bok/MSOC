...
from models.mc_tnc.models.densetcn import DenseTemporalConvNet
from models.mc_tnc.models.resnet import BasicBlock, ResNet
from models.mc_tnc.models.resnet1D import BasicBlock1D, ResNet1D
from models.mc_tnc.models.shufflenetv2 import ShuffleNetV2
from models.mc_tnc.models.swish import Swish
from models.mc_tnc.models.tcn import MultibranchTemporalConvNet, TemporalConvNet
...
class MultiscaleMultibranchTCN(nn.Module):
    ...
    def forward(self, x, lengths, B):
        ...
        tcn_out = self.mb_ms_tcn(xtrans)
        print(f"TCN output shape: {tcn_out.shape}")
        feature = self.consensus_func(tcn_out, lengths, B)
        output = self.tcn_output(feature)
